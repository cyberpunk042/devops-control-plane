"""
K8s pod template builder — probes, volumes, env vars, mesh annotations.

Shared across k8s_generate (simple manifests) and k8s_wizard_generate
(full translator pipeline). Channel-independent.
"""
