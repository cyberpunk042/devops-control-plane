...
def upload_backup_to_release(project_root: Path, backup_path: str) -> dict:
    ...
    try:
        from src.core.services.content.release import upload_to_release_bg
...
def delete_backup_release(project_root: Path, backup_path: str) -> dict:
    ...
    try:
        from src.core.services.content.release import delete_release_asset
...
def _cleanup_release_sidecar(file_path: Path, project_root: Path) -> None:
    ...
    try:
        from src.core.services.content.release import cleanup_release_sidecar
